...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("E://VS Testing LEVIR dataset ONLY//test_6-3-2025_CGNet//checkpoint1-BCE-100epochs//ResUnet99.pth"))
    model.eval()
    test_results_path="E://VS Testing LEVIR dataset ONLY//test_6-3-2025_CGNet//test results//test_results1-100epochs"
    ...
    with torch.no_grad():
        for _, data in enumerate(test_loader):
            ...
            prediction = torch.where(probs> 0.02, 1.0,0.0)
